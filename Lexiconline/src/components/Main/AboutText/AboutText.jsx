...
export const AboutText = ({ headerText, textOne, textTwo, listTextOne, listTextTwo, listTextThree, footerText, footerLink }) => {
  return (
    <>
      {headerText ? <header>
      ...
      <span className={style.textStyling}>
        ...
        {footerText ? <p>{footerText} <span className={style.footerText}><p>{footerLink}</p></span></p> : null}
      </span>
    </>
  );
};
